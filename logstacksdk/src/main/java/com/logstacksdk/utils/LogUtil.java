...
//                Log.e(tag, info);
    ...
    /**
     * Print log for define method. When information is too long, the Logger can also complete printing. The equivalent of "{@code android.utils.Log.i("Tag", "Message")}" "{@code com.yolanda.nohttp.Logger.print("i", "Tag", "Message")}".
     *
